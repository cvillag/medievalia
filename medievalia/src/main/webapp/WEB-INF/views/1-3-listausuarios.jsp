			...
			<table
				...
				for(User u : list){ %>
					<tr id="fila<%=u.getId()%>">
						...
						<td width="20%">
							<button type="button"
								class="btn btn-default navbar-btn deleteuser"
								data-toggle="modal" data-target="#modalBorrar"
								data-val="<%=u.getId() %>">
								<span class="glyphicon glyphicon-remove" aria-hidden="true"></span>
							</button>
							<button type="button"
								class="btn btn-default navbar-btn modifyuser"
								data-val="<%=u.getId() %>">
								<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
							</button>
							<button type="button"
								class="btn btn-default navbar-btn detailsuser"
								data-val="<%=u.getId() %>">
								<span class="glyphicon glyphicon-zoom-in" aria-hidden="true"></span>
							</button>
						</td>
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" id="modalok" class="btn btn-default"
					data-dismiss="modal">
					<fmt:message key="p1-3.modalborrar"></fmt:message>
				</button>
				<button type="button" id="modalcancel" class="btn btn-default"
					data-dismiss="modal">
