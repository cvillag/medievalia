...
<div class="col-md-6 col-md-offset-3">
		<ul class="pagination">
			...
			<li><span id="siguientes" class="glyphicon glyphicon-step-forward" style="color:grey;" title="<fmt:message key="p1-3.2.control4"/>"></span></li>
			<li><span id="ultimos" class="glyphicon glyphicon-fast-forward" style="color:grey;" title="<fmt:message key="p1-3.2.control5"/>"></span></li>
		</ul>
	</div>
</div> 
<div class="container">
