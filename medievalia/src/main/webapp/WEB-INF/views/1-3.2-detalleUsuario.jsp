...
<div class="container">
	<div class="col-md-6 col-md-offset-3">
		<ul class="list-inline">
			<li><span id="inicio" class="glyphicon glyphicon-fast-backward" title="<fmt:message key="p1-3.2.control1"/>"></span></li>
			<li><span id="anterior" class="glyphicon glyphicon-step-backward" title="<fmt:message key="p1-3.2.control2"/>"></span></li>
			<li><fmt:message key="p1-3.2.control3"/>&nbsp;<input type="number" name="pagTo" id="pagTo"></li>
			<li><span id="siguiente" class="glyphicon glyphicon-step-forward" title="<fmt:message key="p1-3.2.control4"/>"></span></li>
			<li><span id="final" class="glyphicon glyphicon-fast-forward" title="<fmt:message key="p1-3.2.control5"/>"></span></li>
		</ul>
	</div>
</div>
<form action="detailUser.do" id="pagForm" method="post">
	...
	<input type="hidden" name="actual"	id="actual" value="<%=request.getAttribute("actual") %>">
