...
<div class="container"">
	...
	<form class="form-horizontal" id="formusuario"
		action="modifyUserAction.do" method="post">
		<fieldset>
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<input id="name" name="name" type="text" placeholder="Login"
						class="form-control input-md" value="<%=user.getUser_name()%>">
		  ...
		  %>
					<label class="radio-inline" for="role-<%=o%>"> <input
						...
						value="<%=r.getRol()%>"
						<% if(r.getRol() == user.getUser_role()){ %> checked <%} %>>
						<%=r.getNombreRol() %>
					</label>
					<%
		  		}
		...
		<div class="form-group">
		  ...
		  <div class="col-md-4">
			...
			<div class="form-group">
				<label class="col-md-4 control-label" for="newpass"><fmt:message
						key="p1-3.1.form.pass" /></label>
				<div class="col-md-4">
			...
			<div class="form-group">
				<label class="col-md-4 control-label" for="newpass2"><fmt:message
						key="p1-3.1.form.pass2" /></label>
				<div class="col-md-4">
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<button id="saveChanges" name="saveChanges" class="btn btn-primary">
	...
	<div class="container">
		...
		<div class="alert alert-danger">
			<fmt:message key="p1-3.1.error.mismatchPass" />
		</div>
		<%}
		else{
			if(message.equals("p1-3.1.error.nok")){ %>
		<div class="alert alert-danger">
			<fmt:message key="p1-3.1.error.nok" />
		</div>
		<%	}
		}%>
		<%} %>
