...
<!--  TOOO: Cambiar el grid -->
	...
	<form class="form-horizontal" id="formusuario" action="createUserAction.do" method="post">
	<fieldset>
	...
	<!-- Text input-->
		...
		<div class="form-group">
		  ...
		  %>
		    <label class="radio-inline" for="role-<%=o%>">
		      <input type="radio" name="role" id="role-<%=o%> %>" value="<%=r.getRol()%>" <% if(o == 3){ %>checked <%} %>>
		      <%=r.getNombreRol() %>
		    </label>
		  <%
		  		}
		...
		<div class="form-group">
		  <label class="col-md-4 control-label" for="pass2"><fmt:message key="p1-2.form.pass2"/></label>
		  <div class="col-md-4">
		    <input id="pass2" name="pass2" type="password" placeholder="<fmt:message key="p1-2.form.passhelp"/>" class="form-control input-md" >
		    <span class="help-block"><fmt:message key="p1-2.form.passnote2"/></span>
		  </div>
		</div>
