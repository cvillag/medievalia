...
<table class="table table-hover table-striped table-condensed table-scrollable">
	...
	<%
		...
		<tr>
			...
			<td><button class="btn btn-default btn-xs selectgrp" data-val="<%=g.getIdGrupo()%>"><span class="glyphicon glyphicon-play" id="selectgrp<%=g.getIdGrupo()%>"></span></button></td>
			<%}
			else{%>
			<td><button class="btn btn-default btn-xs selectedgrp" data-val="<%=g.getIdGrupo()%>"><span class="glyphicon glyphicon-check" id="selectgrp<%=g.getIdGrupo()%>"></span></button></td>
			<%} %>
		</tr>
		<%}
		%>
